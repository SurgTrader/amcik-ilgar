...
client.once('ready', () => { //Client hazır olduğunda
    ...
    client.user.setActivity("By IlgarCaliskan", { //Bot hesabının aktivitesini "Bu bot da Discord'a katıldı" olarak ayarla.
...
client.on("roleDelete", async(role) => {
    ...
    let cezaliRolu = "988791317595299890";
    let logKanali = "988791256668856360";
